...
SwitchingFunction_r::SwitchingFunction_r( const double r_max, 
...
void SwitchingFunction_r::set_r_max(const double r_max)
{
	r_max_ = r_max;
...
void SwitchingFunction_r::setCoarseGrainingParameters(const double sigma, const double alpha_c)
{
...
void SwitchingFunction_r::calculate( const double r, const bool want_derivative,
                                     double& h_r, double& htilde_r, double& dhtilde_r_dr ) const
{
	if ( r > r_outer_ ) {
