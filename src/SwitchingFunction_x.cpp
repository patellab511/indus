// SwitchingFunction_x.cpp
#include "SwitchingFunction_x.h"


SwitchingFunction_x::SwitchingFunction_x( const double x_min, const double x_max, 
                                          const double sigma, const double alpha_c )
	: SwitchingFunction(sigma, alpha_c)
{
	this->setLimits(x_min, x_max);
}


void SwitchingFunction_x::setLimits(const double x_min, const double x_max)
{
	x_min_ = x_min;
	x_max_ = x_max;
...
void SwitchingFunction_x::setCoarseGrainingParameters(const double sigma, const double alpha_c)
{
...
void SwitchingFunction_x::calculate( const double x, const bool want_derivative,
                                     double& h_x, double& htilde_x, double& dhtilde_x_dx ) const
{
